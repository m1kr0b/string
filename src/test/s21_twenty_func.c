...
START_TEST(twenty_func_check)
{
  ...
  ck_assert_int_eq(s21_memcmp(src, dst, 10), memcmp(src, dst, 10));     // MEMCMP
  ck_assert_int_eq(s21_memcmp(src0, dst0, 10), memcmp(src0, dst0, 10)); // MEMCMP
